        ...
        <div class="col-12 my-3">
            <div class="card rounded-0 border-0 shadow">
                <div class="card-body">
                    <div class="d-flex">
                        <div>
                            <h5 class="mb-0 mt-2 text-dark"><b>Gallery</b></h5>
                        </div>
                        <div class="ml-auto">
                            <a href="{{route('admin.gallery.create')}}" class="btn btn-info rounded-0 shadow-none text-white"><i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <img src="{{url('')}}/website/images/gallery/{{$photo->image}}" class="img-fluid" style="width: 150px;">
                        </td>
